                    ...
                    <div class="row g-3">
                        <div class="col-sm-6">
                            <div class="form-floating">
                                <input type="text" class="form-control" name="fullname" value="{{ $user['fullname'] }}" placeholder="ชื่อ-นามสกุล">
                        ...
                        <div class="col-sm-6">
                            <div class="form-floating">
                                <input type="text" class="form-control" name="tel" value="{{ $user['tel'] }}" placeholder="เบอร์โทรศัพท์">
                        ...
                        <div class="col-sm-6">
                            <div class="form-floating">
                                <input type="password" class="form-control" name="password" placeholder="เปลี่ยนรหัสผ่าน">
                                <label for="name">เปลี่ยนรหัสผ่าน</label>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-floating">
                        ...
                        <div class="col-12 text-center">
                            <button class="btn btn-success w-100 py-3" type="submit">บันทึก</button>
                        </div>
                    </div>
                    </form>
                </div>
